...
Usage:
    python3 schemas/invariant_registry/check.py
    python3 schemas/invariant_registry/check.py --repo marketplace=../marketplace
    python3 schemas/invariant_registry/check.py --require-roots   # every root must resolve
...
def validate_schema(registry: dict, schema: dict) -> list[str]:
    ...
    try:
        ...
        raise HarnessError(
            ...
            "schemas/invariant_registry/requirements.txt"
        ) from exc
