module github.com/johnrichter/claude-shared-tooling/go/characterize
...
// clikit, schema, sysops, transcript and logkit are same-repo sibling modules
// (ai-shared-lib/go/clikit, .../go/schema, .../go/sysops, .../go/transcript, .../go/logkit), not
