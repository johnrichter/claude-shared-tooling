---
name: True-Cost Accounting Fixtures — Expected Totals
description: "golden transcript fixture manifest for build-with-team accounting tests (M2.P1.T2 multi-transcript+watermark, M2.P1.T4 per-task attribution) — per-model token totals and dollar costs, arithmetic shown for independent verification"
---
