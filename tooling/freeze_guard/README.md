...
```sh
python3 tooling/freeze_guard/check.py --base <ref>   # diff <ref>..HEAD (CI/pre-merge)
python3 tooling/freeze_guard/check.py                # working-tree mode (local)
python3 tooling/freeze_guard/check.py --list         # list frozen paths
```
