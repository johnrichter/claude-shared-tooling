...
Usage:
  python3 tooling/codegov_lint/check.py --diff REF   (CI mode: lint files changed since REF)
  python3 tooling/codegov_lint/check.py --files PATH...
  python3 tooling/codegov_lint/check.py --all         (audit mode, full tracked tree)
