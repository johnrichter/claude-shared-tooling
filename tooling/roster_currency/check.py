...
Usage: python3 tooling/roster_currency/check.py
...
_ROSTER_GEN = _REPO_ROOT / "tooling" / "roster_gen"
...
def main() -> int:
    ...
    if failures:
        print(
            ...
            "artifact(s) drifted or missing — regenerate with tooling/roster_gen/generate.py",
            file=sys.stderr,
        )
        return 1
    print(
