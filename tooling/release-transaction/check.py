...
Usage:
    ...
    python3 tooling/release-transaction/check.py render-manifest
        --version 1.2.3 --artifact linux-x86_64=dist/tool-linux-x86_64
    python3 tooling/release-transaction/check.py verify-manifest
        --manifest dist/manifest.json --public-key release-pubkey.pem
    python3 tooling/release-transaction/check.py provision --name tool --version 1.2.3
